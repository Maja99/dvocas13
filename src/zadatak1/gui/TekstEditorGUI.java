				...
				public void actionPerformed(ActionEvent arg0) {
					...
					try {
						...
						JOptionPane.showMessageDialog(
								null, // roditeljski prozor. Ukoliko je null, dijalog ce se prikazati
										// na sredini prozora. Moze se proslediti i 
										// TekstEditorGUI.this kao roditelj. U tom slucaju ce se
										// dijalog prikazati na sredini tog prozora.
								"Greska prilikom ucitavanja teksta.", 
								"Greska", 
					...
					try {
						...
						JOptionPane.showMessageDialog(
								null, // roditeljski prozor. Ukoliko je null, dijalog ce se prikazati
										...
										// TekstEditorGUI.this kao roditelj. U tom slucaju ce se
										// dijalog prikazati na sredini tog prozora.
								"Tekst je uspesno upisan u fajl.", 
								"Uspesno", 
						...
						JOptionPane.showMessageDialog(
								null, // roditeljski prozor. Ukoliko je null, dijalog ce se prikazati
										...
										// TekstEditorGUI.this kao roditelj. U tom slucaju ce se
										// dijalog prikazati na sredini tog prozora.
								"Greska prilikom upisivanja teksta.", 
								"Greska", 
								JOptionPane.ERROR_MESSAGE);
					}
				}
				...
				public void actionPerformed(ActionEvent e) {
					...
					JOptionPane.showMessageDialog(
							null, // roditeljski prozor. Ukoliko je null, dijalog ce se prikazati
									...
									// TekstEditorGUI.this kao roditelj. U tom slucaju ce se
									// dijalog prikazati na sredini tog prozora.
							"Broj znakova u tekstu: " + brojSlova + ". Broj reci: " + brojReci, 
							"Analiza teksta",
							JOptionPane.INFORMATION_MESSAGE);
				}
			});
